                    ...
                    <div class="d-inline-flex dropdown">
                        <a href="#" role="button" id="navDropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" class="header_profile">
                            <div class="circleimg h30 w30">
                                <img src="<?= _DIR ?>/static/img/profile/<?= getMainImgSrc() ?>" onerror=" this.src='<?= _DIR ?>/static/img/profile/defaultProfileImg_100.png'">
                            </div>
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navDropdownMenuLink">
                            <li>
                                <a class="dropdown-item" href="<?= _DIR ?>/user/profile?i_user???">
                            ...
                            <li><a class="dropdown-item" href="<?= _DIR ?>/user/logout">로그아웃</a></li>
                        </ul>
                    </div>
